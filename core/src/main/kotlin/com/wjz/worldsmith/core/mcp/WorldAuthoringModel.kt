...
object WorldAuthoringModel {
    ...
    const val CAPABILITY_CONTRACT = "minecraft26.2-pack6-items2-creatures3-quests1-authoring1"
    ...
    private val targetKinds = setOf("terrain", "anchor", "feature", "biome", "structure", "blueprint", "drawing", "block", "block_item", "item", "creature", "quest", "theme", "narrative_beat")
