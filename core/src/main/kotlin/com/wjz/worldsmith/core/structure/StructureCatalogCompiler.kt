...
object StructureCatalogCompiler {
    ...
    @JvmStatic fun compile(library:StructureLibrary):CompiledStructureCatalog {
        need(library.schemaVersion in 1..3 && library.structures.size<=StructureValidator.MAX_STRUCTURES,"structures","STRUCTURE_CATALOG_LIMIT","Use schema 1/2/3 and at most ${StructureValidator.MAX_STRUCTURES} definitions")
